...
rf1 <- randomForest(PredictedClass ~ ., data=raw.train, ntree=100, importance=TRUE)
...
library(rpart)
tree1 <- rpart(PredictedClass ~ ., data=raw.train,method='class',cp=.005,xval=20)
printcp(tree1)
...
CrossTable(tree.predict,raw.valid$PredictedClass,format="SPSS",prop.r="FALSE",prop.c="TRUE",prop.chisq="FALSE")
CrossTable(forest.predict,raw.valid$PredictedClass,format="SPSS",prop.r="FALSE",prop.c="TRUE",prop.chisq="FALSE")
CrossTable(prunetree.predict,raw.valid$PredictedClass,format="SPSS",prop.r="FALSE",prop.c="TRUE",prop.chisq="FALSE")
